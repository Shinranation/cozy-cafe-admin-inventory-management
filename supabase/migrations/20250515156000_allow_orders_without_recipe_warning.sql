-- Cozy Cafe POS: allow menu items without recipe links.
-- Orders still deduct stock for linked recipe ingredients, but unlinked items
-- can be sold without inventory deduction.
